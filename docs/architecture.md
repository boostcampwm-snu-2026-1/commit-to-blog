...
6. The server formats the commit data and calls OpenAI to generate a blog draft.
...
- `backend/`
  - Handles GitHub API, OpenAI API, and MongoDB access.
