...
- [x] 서비스 핵심 기능 정의
- [x] GitHub 저장소, 브랜치, 커밋, 블로그 포스트 데이터 구조 정의
- [x] React 기반 화면/컴포넌트 구조 설계
- [x] Express 기반 서버 디렉토리 구조 설계
- [x] GitHub Repository 선택 화면 만들기
- [x] 브랜치 선택 UI 만들기
- [x] 커밋 목록 선택 UI 만들기
- [x] AI 블로그 초안 편집기 UI 만들기
- [x] 저장된 포스트 카드 목록 UI 만들기
- [x] mock 데이터로 전체 화면 흐름 연결
...
- [x] 주차별 계획 문서가 있다.
- [x] 데이터 구조 초안이 정리되어 있다.
- [x] 화면/컴포넌트 구조가 정리되어 있다.
- [x] mock 데이터로 저장소, 브랜치, 커밋, 포스트 화면을 확인할 수 있다.
- [x] 2주차에 API 연동으로 교체할 지점이 명확하다.
