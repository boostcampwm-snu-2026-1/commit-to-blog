...
npm test -w apps/server      # Vitest 단위 테스트 (13건)
```
...
# week12 추가
curl 'http://localhost:4000/api/repos/jj1kim/commit-to-blog/branches'
curl 'http://localhost:4000/api/repos/jj1kim/commit-to-blog/commits?branch=main&limit=5'
curl -X POST http://localhost:4000/api/posts/draft \
  -H 'Content-Type: application/json' \
  -d '{"repoFullName":"jj1kim/commit-to-blog","branch":"main","commitShas":["a1b2c3d4e5f6789012345678901234567890abcd"]}'
